...
Model.prototype = {
	...
	findOneByID: function(id, callback) {
		if (!callback) {
			return Q.npost(this, 'findOneByID', arguments);
		}
	...
	findManyByView: function(viewPath, params,	callback) {
		if (!callback) {
			return Q.npost(this, 'findManyByView', arguments);
		}
...
Instance.prototype = {
	...
	save: function(callback) {
		if (!callback) {
			return Q.npost(this, 'save', arguments);
		}
	...
	delete: function(callback) {
		if (!callback) {
			return Q.npost(this, 'delete', arguments);
		}
